...
//#define LCD_AFONT "ILGH16XB.FNT"		// 1バイトフォントファイル名
//#define LCD_KFONT "ILGZ16XB.FNT"		// 2バイトフォントファイル名
//#define LCD_AFONT "ILGH24XB.FNT"		// 1バイトフォントファイル名
//#define LCD_KFONT "ILGZ24XB.FNT"		// 2バイトフォントファイル名
//#define LCD_AFONT "ILGH24XF.FNT"		// 1バイトフォントファイル名
//#define LCD_KFONT "ILGZ24XF.FNT"		// 2バイトフォントファイル名
...
#define LCD_ASPACE	1				// FONTX2 1バイトフォントの横方向スペーシング
#define LCD_KSPACE	1				// FONTX2 2バイトフォントの横方向スペーシング
#define FONT_HEIGHT 17				// 自動改行時の1行の高さ
//#define FONT_HEIGHT 25				// 自動改行時の1行の高さ
//#define FONT_HEIGHT 22				// 自動改行時の1行の高さ
